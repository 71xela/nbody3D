_report = {
  metrics = {
    ...
    compilation_flags = "icc_nbody3: Intel 2021.4.0 -g -xhost -Ofast -qopt-report=5 -o icc_nbody3 -qmkl -qopenmp \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 98.73,
    speedup_if_fp_vect = 1.0019,
    ...
    speedup_if_fully_vectorised = 1.0034,
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.1452,
    nb_threads = 1,
    application_time = 1.58,
    compilation_options = "OK",
    innerloops_time = 98.1,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.559934 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.54998 seconds.",
  },
  colors = {
