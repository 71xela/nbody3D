_report = {
  metrics = {
    ...
    compilation_flags = "icc_nbody4: Intel 2021.4.0 -g -xhost -Ofast -funroll-loops -qopt-report=5 -o icc_nbody4 -qmkl -qopenmp \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 99.36,
    speedup_if_fp_vect = 1.0058,
    ...
    speedup_if_fully_vectorised = 1.0111,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0037,
    profiled_time = 1.57,
    array_access_efficiency = 99.973325881516,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.1541,
    nb_threads = 1,
    application_time = 1.57,
    compilation_options = "OK",
    innerloops_time = 98.41,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.559952 seconds.",
    ...
    profiled_time = "Application profiling duration in seconds<br><b>Too short run</b>: statistical accuracy of profiling results is average (profiled time corresponds to 315 samples)<br><b>Workaround</b>: Rerun with a longer workload and/or use sampling-rate=high/highest in lprof_params",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.545037 seconds.",
  },
  colors = {
